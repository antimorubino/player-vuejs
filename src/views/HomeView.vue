...
const columns = [
  { data: null,
    render: function(data) {
      return `<a href="#?" data-id="${data.id}" data-src="${data.src}" data-titolo="${data.titolo}" data-pdf="${data.pdf}" class="play">${data.titolo}</a>`;
...
<template>
  ...
  <div class="container">
    <DataTable :columns="columns" ajax="./data.json" class="table table-striped table-bordered tableSong" 
      :options="{
        language: {
          'search': 'Cerca',
